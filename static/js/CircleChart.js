function CircleChart() {
    ...
    function draw() {
        ...
        context.lineWidth = 10; // TODO: Make a param.
        context.stroke();
        shadowOn();
        ...
        context.lineWidth = 20; // TODO: Make a param.
        context.stroke();
...
// var values = {
//     "url": "http://0.0.0.0:5000/api/fight",
//     "method": "GET/POST"
// }
//
// $.ajax(values).done(function (response) {
//     console.log(response);
//
//     // var content = {
//     //     // fight: response.fight,
//     //     per_fight: response.precentegeoffight,
...
//     setInterval(function(){
        ...
        //     url: "http://0.0.0.0:5000/api/fight",
        //     success: function (xhr,ajaxOptions, error){
